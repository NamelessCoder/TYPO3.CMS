...
class BackendModuleController
{
    ...
    public function index(ServerRequestInterface $request, ResponseInterface $response)
    {
        ...
        if ($enableFileService->checkInstallToolEnableFile()) {
            ...
            $response = $response->withStatus(303)->withHeader('Location', 'sysext/core/Start/Install.php?install[context]=backend');
            ...
            $view->setTemplatePathAndFilename(GeneralUtility::getFileAbsFileName(
                'EXT:core/Resources/Private/Templates/BackendModule/ShowEnableInstallToolButton.html')
            );
