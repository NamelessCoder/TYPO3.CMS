    ...
    public function printClipboard()
    {
        ...
        if ($elementCount) {
            ...
            $btnOkText = $languageService
                ->sL('LLL:EXT:core/Resources/Private/Language/locallang_alt_doc.xlf:buttons.confirm.delete_elements.yes');
            $btnCancelText = $languageService
                ->sL('LLL:EXT:core/Resources/Private/Language/locallang_alt_doc.xlf:buttons.confirm.delete_elements.no');
            $optionArray[] = [
