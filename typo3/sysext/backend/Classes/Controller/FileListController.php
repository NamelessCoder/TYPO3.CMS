...
use TYPO3\CMS\Backend\FileList\FileList;
...
class FileListController extends ActionController
{
    ...
    public function initializeObject()
    {
        ...
        $this->getLanguageService()->includeLLFile('EXT:core/Resources/Private/Language/locallang_mod_file_list.xlf');
    ...
    public function initializeView(ViewInterface $view)
    {
        ...
        $pageRenderer->loadRequireJsModule('TYPO3/Backend/Filelist/FileListLocalisation');
        $pageRenderer->loadRequireJsModule('TYPO3/Backend/Filelist/FileSearch');
    ...
    public function indexAction()
    {
        ...
        if ($this->folderObject) {
            ...
            $this->view->getModuleTemplate()->addJavaScriptCode(
                ...
                ');
            $pageRenderer->loadRequireJsModule('TYPO3/Backend/Filelist/FileDelete');
            $pageRenderer->addInlineLanguageLabelFile('EXT:core/Resources/Private/Language/locallang_alt_doc.xlf', 'buttons');
    ...
    public function searchAction($searchWord = '')
    {
        ...
        if (empty($files)) {
            ...
            foreach ($files as $file) {
                $fileFacades[] = new \TYPO3\CMS\Backend\FileList\FileFacade($file);
            }
        }

        $pageRenderer = $this->view->getModuleTemplate()->getPageRenderer();
        $pageRenderer->loadRequireJsModule('TYPO3/Backend/Filelist/FileList');
