...
class TypoScriptTemplateModuleController extends BaseScriptClass
{
    ...
    public function main()
    {
        ...
        $view = $this->getFluidTemplateObject('backend');
        ...
        if ($this->id && $this->access) {
            ...
            $this->moduleTemplate->addJavaScriptCode(
                ...
                . GeneralUtility::quoteJSvalue(
                    $aHref . '&SET[function]=TYPO3\\CMS\\Backend\\Controller\\'
    ...
    public function linkWrapTemplateTitle($title, $onlyKey = '')
    {
        ...
        $aHref = BackendUtility::getModuleUrl('web_ts', $urlParameters);
        if ($onlyKey) {
            $title = '<a href="' . htmlspecialchars(($aHref . '&e[' . $onlyKey . ']=1&SET[function]=TYPO3\\CMS\\Backend\\Controller\\TypoScriptTemplateInformationModuleFunctionController')) . '">' . htmlspecialchars($title) . '</a>';
        } else {
            $title = '<a href="' . htmlspecialchars(($aHref . '&e[constants]=1&e[config]=1&SET[function]=TYPO3\\CMS\\Backend\\Controller\\TypoScriptTemplateInformationModuleFunctionController')) . '">' . htmlspecialchars($title) . '</a>';
        }
        return $title;
    }
    ...
    public function noTemplate($newStandardTemplate = 0)
    {
        ...
        $view = $this->getFluidTemplateObject('backend', 'NoTemplate');
