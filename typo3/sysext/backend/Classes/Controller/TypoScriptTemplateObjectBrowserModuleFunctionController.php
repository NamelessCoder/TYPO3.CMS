...
class TypoScriptTemplateObjectBrowserModuleFunctionController extends AbstractFunctionModule
{
    ...
    public function init(&$pObj, $conf)
    {
        ...
        $this->localLanguageFilePath = 'EXT:backend/Resources/Private/Language/locallang_objbrowser.xlf';
    }
    ...
    public function modMenu()
    {
        ...
        $lang->includeLLFile('EXT:backend/Resources/Private/Language/locallang_objbrowser.xlf');
        $modMenu = [
            'ts_browser_type' => [
    ...
    public function main()
    {
        ...
        if ($this->pObj->sObj) {
            ...
            if (!empty($this->templateService->parserErrors[$pEkey])) {
                $assigns['showErrorDetailsUri'] = $aHref . '&SET[function]=TYPO3\\CMS\\Backend\\Controller\\TemplateAnalyzerModuleFunctionController&template=all&SET[ts_analyzer_checkLinenum]=1#line-';
        ...
        $view->setTemplatePathAndFilename(GeneralUtility::getFileAbsFileName(
            'EXT:backend/Resources/Private/Templates/TemplateObjectBrowserModuleFunction.html'
        ));
