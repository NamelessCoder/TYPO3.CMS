...
class TemplateAnalyzerModuleFunctionController extends AbstractFunctionModule
{
    ...
    public function init(&$pObj, $conf)
    {
        ...
        $this->localLanguageFilePath = 'EXT:backend/Resources/Private/Language/locallang_analyzer.xlf';
    ...
    public function main()
    {
        ...
        $view->setTemplatePathAndFilename(GeneralUtility::getFileAbsFileName(
            'EXT:backend/Resources/Private/Templates/TemplateAnalyzerModuleFunction.html'
        ));
