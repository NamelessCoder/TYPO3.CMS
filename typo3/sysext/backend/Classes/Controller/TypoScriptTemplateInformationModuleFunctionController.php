...
class TypoScriptTemplateInformationModuleFunctionController extends AbstractFunctionModule
{
    ...
    public function main()
    {
        ...
        if ($existTemplate) {
            ...
            $lang->includeLLFile('EXT:backend/Resources/Private/Language/locallang_info.xlf');
            $assigns = [];
            $assigns['LLPrefix'] = 'LLL:EXT:backend/Resources/Private/Language/locallang_info.xlf:';
            // Update template ?
            ...
            $view->setTemplatePathAndFilename(GeneralUtility::getFileAbsFileName(
                'EXT:backend/Resources/Private/Templates/InformationModule.html'
            ));
