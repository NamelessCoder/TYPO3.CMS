...
class RecordHistory
{
    ...
    public function displayHistory()
    {
        ...
        foreach ($this->changeLog as $sysLogUid => $entry) {
            ...
            // add time
            $singleLine['age'] = htmlspecialchars(BackendUtility::calcAge($GLOBALS['EXEC_TIME'] - $entry['tstamp'], $languageService->sL('LLL:EXT:core/Resources/Private/Language/locallang_core.xlf:labels.minutesHoursDaysYears')));
            // add age
