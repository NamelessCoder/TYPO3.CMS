    ...
    public static function TYPO3_copyRightNotice()
    {
        ...
        if (strlen($loginCopyrightWarrantyProvider) >= 2 && strlen($loginCopyrightWarrantyURL) >= 10) {
            $warrantyNote = sprintf(
                $lang->sL('LLL:EXT:core/Resources/Private/Language/locallang_login.xlf:warranty.by'),
            ...
            $warrantyNote = sprintf(
                $lang->sL('LLL:EXT:core/Resources/Private/Language/locallang_login.xlf:no.warranty'),
                '<a href="' . TYPO3_URL_LICENSE . '" target="_blank">',
                '</a>'
            );
        }
        $cNotice = '<a href="' . TYPO3_URL_GENERAL . '" target="_blank">' .
            $lang->sL('LLL:EXT:core/Resources/Private/Language/locallang_login.xlf:typo3.cms') . '</a>. ' .
            $lang->sL('LLL:EXT:core/Resources/Private/Language/locallang_login.xlf:copyright') . ' &copy; '
            . htmlspecialchars(TYPO3_copyright_year) . ' Kasper Sk&aring;rh&oslash;j. ' .
            $lang->sL('LLL:EXT:core/Resources/Private/Language/locallang_login.xlf:extension.copyright') . ' ' .
            sprintf(
                $lang->sL('LLL:EXT:core/Resources/Private/Language/locallang_login.xlf:details.link'),
                ('<a href="' . TYPO3_URL_GENERAL . '" target="_blank">' . TYPO3_URL_GENERAL . '</a>')
            ) . ' ' .
            strip_tags($warrantyNote, '<a>') . ' ' .
            sprintf(
                $lang->sL('LLL:EXT:core/Resources/Private/Language/locallang_login.xlf:free.software'),
                ('<a href="' . TYPO3_URL_LICENSE . '" target="_blank">'),
                '</a> ')
            . $lang->sL('LLL:EXT:core/Resources/Private/Language/locallang_login.xlf:keep.notice');
        return $cNotice;
    }
