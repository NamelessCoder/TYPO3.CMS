...
/**
 * Module: TYPO3/CMS/Backend/FileLinkHandler
 * File link interaction
 */
define(['jquery', 'TYPO3/CMS/Backend/LinkBrowser', 'TYPO3/CMS/Backend/LegacyTree'], function($, LinkBrowser, Tree) {
	'use strict';

	/**
	 *
	 * @type {{currentLink: string}}
	 * @exports TYPO3/CMS/Backend/FileLinkHandler
	 */
	var FileLinkHandler = {
		currentLink: ''
	};
