...
/**
 * Module: TYPO3/CMS/Backend/BrowseFiles
 * File selection
 */
define(['jquery', 'TYPO3/CMS/Backend/ElementBrowser', 'TYPO3/CMS/Backend/LegacyTree'], function($, ElementBrowser, Tree) {
	'use strict';

	/**
	 *
	 * @type {{elements: {}}}
	 * @exports TYPO3/CMS/Backend/BrowseFiles
	 */
	var BrowseFiles = {
		elements: {}
	};
